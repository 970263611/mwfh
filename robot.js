...
class MouseKeyboardPlayer {
    constructor() {
        ...
        // 启动渲染定时器替代requestAnimationFrame，仅修复报错，不改原有逻辑
        this.#initRenderTimer();
    }

    // 初始化定时器，只处理最新mouseQueue，还原原版手感
    #initRenderTimer() {
        // 60帧间隔，等价raf，不改变原有移动逻辑
